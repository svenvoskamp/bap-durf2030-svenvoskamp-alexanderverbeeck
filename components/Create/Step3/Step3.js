                ...
                {data && (
                  <>
                    {data.needs.length >= 1 && (
                      <>
                        <p className={style.empty_add}>
                          Bedankt voor het toevoegen! Wil je nog meer
                          benodigheden toevoegen?
                        </p>
                      </>
                    )}
                  </>
