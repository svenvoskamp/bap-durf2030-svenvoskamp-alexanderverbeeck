...
const Tyle = ({ color, direction, button, project }) => {
  ...
  return (
      <article className={`card scale`}data-scroll data-scroll-speed={direction} data-scroll-direction="vertical">
        <div className={style.card_tags} data-scroll data-scroll-speed="0.7" data-scroll-direction="horizontal">
        ...
        <a href={'/detail/' + project.id} data-scroll>
          <div className={`card_info card_info__${color}`}>
            ...
            <div></div>
            <img loading="lazy" ref={imgRef} className={style.card_image} src="" alt={project.title}/>
          </div>
        </a>

        <div data-scroll data-scroll-direction="vertical" data-scroll-speed={button} className={style.button}>
          <div className={style.circle_button}>
            <img className={style.button_image} src="./assets/images/account_aanmaken.svg" />
          </div>
        </div>
      </article>
  );
