...
const Login = () => {
  return (
    <button
      className="profile-button scale"
      onClick={() => Router.push("/api/login")}
    >
      <div className="nav-item">
        <svg
          className="nav-item--image scale"
          width="16"
          height="15"
          viewBox="0 0 16 15"
          fill="none"
