          ...
          {company == true && (
            <>
              <div className={style.form}>
                ...
                <div className={style.input_container}>
                  <label htmlFor="companyName" className={style.label}>Bedrijfsnaam:</label>
                  <input
                    required
                    id="companyName"
                    min="0"
                ...
                <div className={style.input_container}>
                  <label htmlFor="department" className={style.label}>Bedrijfsafdeling:</label>
                  <input
                    required
                    id="department"
                    min="0"
                ...
                <div className={style.input_container}>
                  <label for="sectors" className={style.label}>Bedrijfssector </label>
                  <select
                    name="sectors"
                    id="sectors"
                    required
